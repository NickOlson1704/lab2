...
let lovesCode = true
  ...
  if(lovesCode === lovesCode){
      console.log("I love to code")
    }else{(lovesCode !== lovesCode)
...
amysBirthYear = 1991;
brittanisBirthYear = 1986;

if(amysBirthYear === brittanisBirthYear){
  console.log("Amy & Brittani were born in the same year")

}else if(amysBirthYear !== brittanisBirthYear){
  console.log("Amy & Brittani were notborn in the same year")
}
////////// PROBLEM 4 //////////
...
console.log(changeMyMind) //changeMyMind should = false
...
console.log(changeMyMind)  //changeMyMind should = true
